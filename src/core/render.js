...
import { now, clamp, round, lerp, forEachChildren } from "./helpers.js";
...
export const tick = (
  ...
  if (tickable._hasChildren) {
    ...
    if (
      (tlChildrenHaveCompleted || tlIsRunningBackwards) &&
      tl._currentTime >= tl.duration
    ) {
